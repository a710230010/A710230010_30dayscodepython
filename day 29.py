...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create six QPushButton widgets for the mathematical operations
    ...
    def modulus_numbers(self):
        # Calculate the modulus of the numbers entered by the user and display the result
        result = float(self.first_number.text()) % float(self.second_number.text())
        self.result_label.setText(str(result))

    def power_numbers(self):
        # Calculate the power of the numbers entered by the user and display the result
        result = float(self.first_number.text()) ** float(self.second_number.text())
        self.result_label.setText(str(result))
